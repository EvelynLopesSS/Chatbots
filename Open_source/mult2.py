...
import os
import glob
from langchain_community.document_loaders import UnstructuredWordDocumentLoader, UnstructuredPowerPointLoader, UnstructuredURLLoader, UnstructuredPDFLoader
...
# Função para extrair e processar o texto do arquivo
def extract_text_from_pdf(file_path):
    loader = PyPDFLoader(file_path)
    text=loader.load()
    return text

# Função para extrair e processar o texto do arquivo PowerPoint
...
st.markdown("""
    ...
    - Uma vez que você veja uma mensagem indicando que seu documento foi processado, você pode começar a fazer perguntas na entrada do chat para interagir com o conteúdo do documento.
    ---
...
if uploaded_file is not None:
    ...
    # Obter a entrada do usuário e responder
